                ...
                <li style="display: flex;">
                    ...
                    <div style="width: 620;padding: 10px 0 0 10px;">
                        <ul class="book-property">
                            <li>
                                <span class="book-property__title">书名：</span><a href="/e_books/4110">Grokking Web
                                    Application Security</a>
                            </li>

                            <li>
                                <span class="book-property__title">作者：</span><span>Malcolm McDonald</span>
                            </li>
                            <li>
                                <span class="book-property__title">语言：</span><span>英文</span>
                            </li>
                            <li>
                                <span class="book-property__title">出版年份：</span><span>2024</span>
                            </li>
                        </ul>
                    </div>
                </li>
