<template>
    <div style="margin-left:auto;margin-right:auto;width:1000px;margin-top:44px;">
        <div style="margin: 25px 0 25px;" class="shadow-panel">
            ...
            <router-Link :to="'/'">
                <img src="../../images/back2.png" alt="back" class="navigation">
            </router-Link>
            ...
            <div style="display: flex;flex-direction: column-reverse;padding-bottom: 4px;">
                <img src="../../images/like.png" alt="" class="navigation" @click="click">
                <img src="../../images/share.png" alt="share" style="margin-bottom: 5px;" class="navigation like">
            </div>
...
export default {
    data() {
        return {
            ...
            likeIndex: 0,
            likeurl: require("../../images/unlike.png")
        }
    },
    computed: {
        ...mapState({
        ...
        click() {
            this.likeIndex--;
            if (this.likeIndex < 0) {
                this.likeIndex = this.likeArr.length - 1
            }
            this.likeurl = require(this.likeArr[this.likeIndex])
        }
    },
}
</script>
