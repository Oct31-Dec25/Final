        ...
        <div style="margin: 25px 0 25px" class="shadow-panel">
            ...
            <div style="width: 460px;margin-left: auto;">
                <div style="height: 410px; padding-top: 20px;">
                    ...
                    <div>
                        <table style="border: solid 2px;width: 460px;height: 40px;">
                            <tr>
                                <td style="text-align: right;width: 120px;padding: 0 10px 0 0;">hlakf</td>
                                <td style="padding: 0 0 0 10px;">hlakfgjsafgsjkfgsjfasgjgawi</td>
                            </tr>
                        </table>
                    </div>
                </div>
