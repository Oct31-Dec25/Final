    ...
    <div>
        <div v-for="item in authors" :key="item.id">
            <div style="border: solid 2px;border-radius: 20px;margin-bottom: 10px;padding: 10px;">
                ...
                <div>
                    <ul>
                        <li><span style="font-weight: bold;">代表作品 · · · · · ·</span></li>
                        <li v-for="item in booklist.slice(0, 1)">
...
export default {
    ...
    computed: {
        ...
        selectedBooks() {
            return this.selectedAuthorName !== null ? this.booklist.fliter((book) => book.AuthorID === authorId) : [];
        }
    },
    methods: {
