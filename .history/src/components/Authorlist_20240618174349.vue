<template>
    <div>
        <div v-for="item in authorsWithBooks" :key="item.id">
            <div style="border: solid 2px;border-radius: 20px;margin-bottom: 10px;padding: 10px;width: 100%vw;">
                ...
                <div>
                    <ul>
                        ...
                        <li><span style="font-weight: bold;cursor: pointer;">点击查看代表作品 · · · · · ·</span></li>
                    </ul>
                </div>
                <div>
                    <ul style="display: ;">
                        <li v-for="book in item.books" :key="book.id" style="display: inline-block;width: 117px;">
...
export default {
    ...
    computed: {
        ...
        authorsWithBooks() {
            return this.authors.map(author => {//使用map扩展authors
                return {
                    ...author,
