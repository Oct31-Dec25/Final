<template>
    <div style="margin-left:auto;margin-right:auto;width:1000px;margin-top:44px;">
        <div style="margin: 25px 0 25px;" class="shadow-panel">
            ...
            <router-Link :to="'/'">
                <img src="../../images/back.png" alt="back" class="navigation">
            </router-Link>
            ...
            <div style="display: flex;flex-direction: column-reverse;padding-bottom: 4px;">
                ...
                <img src="../../images/share.png" alt="share" style="margin-bottom: 5px;" class="navigation">
                <img src="../../images/viewlist.png" alt="share" style="margin-bottom: 5px;" class="navigation">
            </div>
