<template>
    <div style="margin-left:auto;margin-right:auto;width:80vw;margin-top:0;">
   
        <div style="display: flex;justify-content: space-between; box-shadow: 20px 15px 30px rgba(0, 0, 0, 0.1);">
            <!-- TODO 设置logo -->
            <img src="../../images/booklogo.png" alt="" style="height: 50px;">
        ...
        <div style="border: solid 2px #d3d3d3;width: 100%vw;"></div>
    </div>
</template>
