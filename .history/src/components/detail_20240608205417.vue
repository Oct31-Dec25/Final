            ...
            <div style="width: 460px;margin-left: auto;">
                <div style="height: 410px; padding-top: 20px;">
                    ...
                    <div style="font-size: 24px;margin-top: 25px;">
                        <table>
                            <tr>
                                <td style="text-align: right;width: 120px;padding: 0 10px ;">hlakf:</td>
                                <td style="text-align: left;width: 120px;padding: 0 10px ;padding: 0 0 0 10;">
                                    gfssjfagaskjsgfkagfsjk
                                </td>
                            </tr>
                        </table>
                    </div>
